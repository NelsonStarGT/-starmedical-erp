...
const ROLE_DEFAULT_PERMISSIONS: Record<string, string[]> = {
  ...
  SUPERVISOR: [
    ...
    PERMISSIONS.MEMBERSHIPS_PRICING_VIEW
  ],
  SALES: [
    PERMISSIONS.LEAD_READ,
    PERMISSIONS.LEAD_WRITE,
  ...
  OPS: [
    ...
    PERMISSIONS.CLIENTS_REPORTS_VIEW,
    PERMISSIONS.CLIENTS_REPORTS_EXPORT,
    PERMISSIONS.CLIENTS_REPORTS_EXPORT_FULL,
    PERMISSIONS.CLIENTS_REPORTS_EXPORT_MASKED
  ],
  TENANT_ADMIN: [
    PERMISSIONS.RECEPTION_VIEW,
    PERMISSIONS.RECEPTION_QUEUE_VIEW,
  ...
  FINANCE: [
    ...
    PERMISSIONS.MEMBERSHIPS_READ,
    PERMISSIONS.MEMBERSHIPS_PRICING_VIEW,
    PERMISSIONS.MEMBERSHIPS_PAYMENTS_ADMIN,
    PERMISSIONS.RECEPTION_VIEW,
    PERMISSIONS.RECEPTION_CASHIER_VIEW,
    PERMISSIONS.RECEPTION_CASHIER_WRITE
  ]
