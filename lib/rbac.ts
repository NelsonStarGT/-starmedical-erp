...
const ROLE_DEFAULT_PERMISSIONS: Record<string, string[]> = {
  ...
  RECEPTION: [PERMISSIONS.LEAD_READ, PERMISSIONS.DEAL_READ, PERMISSIONS.QUOTE_READ, PERMISSIONS.MEMBERSHIPS_READ],
  FINANCE: [PERMISSIONS.QUOTE_READ, PERMISSIONS.QUOTE_APPROVE, PERMISSIONS.MEMBERSHIPS_READ]
};
