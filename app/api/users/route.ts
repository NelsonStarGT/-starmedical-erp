...
async function handler(req: NextRequest) {
  ...
  if (req.method === "GET") {
    const data = await listAdminUsers({
      ...
      roleName: req.nextUrl.searchParams.get("roleName") || req.nextUrl.searchParams.get("roleBaseKey") || "",
  ...
  if (req.method === "POST") {
    ...
    const result = await createUserWithOptionalHrProfile(prisma as any, {
