...
export const HR_EMPLOYEE_STATUSES = ["ACTIVE", "SUSPENDED", "TERMINATED", "ARCHIVED"] as const;
...
export const PAYROLL_RUN_STATUSES = ["DRAFT", "REVIEW", "APPROVED", "PUBLISHED", "PAID", "CLOSED"] as const;
export type PayrollRunStatus = (typeof PAYROLL_RUN_STATUSES)[number];

export const PAYROLL_RUN_TYPES = ["REGULAR", "EXTRA"] as const;
export type PayrollRunType = (typeof PAYROLL_RUN_TYPES)[number];

export const PAYROLL_PAYMENT_STATUSES = ["PENDING", "PAID", "SIGNED"] as const;
